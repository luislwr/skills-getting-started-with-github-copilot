  ...
  async function fetchActivities() {
    try {
      ...
      Object.entries(activities).forEach(([name, details]) => {
        ...
        // Crear lista de participantes con ícono de eliminar y sin bullets
        ...
        if (details.participants.length > 0) {
              ...
              <ul class="participants-list no-bullets">
                ${details.participants.map(p => `
                  <li class="participant-item">
                    ...
                    <button class="delete-participant round-delete-btn" data-activity="${name}" data-email="${p}" title="Eliminar participante">❌</button>
                  </li>
                `).join("")}
              </ul>
            </div>
          ...
          participantsHTML = `
            <div class="participants-section">
              <em>No hay participantes registrados aún.</em>
            </div>
          `;
        }
      ...
      // Event delegation para eliminar participante
